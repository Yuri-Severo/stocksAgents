...
def fetch_stock_price(ticket):
    stock = yf.download(ticket, start='2024-01-01', end='2024-06-01')
    return stock
...
os.environ['OPENAI_API_KEY'] = st.secrets['OPENAI_APÌ_KEY']
...
getStockPrice = Task(
    description = "Analyze the stock {ticket} price and history and create a trend analyses of up, down or sideways",
...
newsAnalyst = Agent(
    ...
    goal="""Create a short summary of the market news related to the stock {ticket} company. Specify the current trend - up, down or sideways with the 
    news context. For each request stock asset, specify a number between 0 and 100, where 0 is extreme fear and 100 is extreme greed.""",
    backstory="""
...
stockAnalystWrite = Agent(
    ...
    You understand macro factors and combine multiple thories - eg. cycle theory and fundamental analyses.
